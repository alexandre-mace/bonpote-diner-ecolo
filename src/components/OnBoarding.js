    ...
    <>
        {
            [0, 1].map(i => (
                    <div
                        key={i}
                        className={`container text-blue-2 w-[100%] ${i === 1 ? 'pointer-events-none -rotate-3 z-10' : 'custom-shadow-1 z-20'} absolute top-1/2 left-1/2 mx-auto -translate-x-1/2 -translate-y-1/2 rounded-xl bg-white p-8 text-center md:max-w-2xl`}>
                        <div
