        ...
        <defs>
                <linearGradient id="left-to-right">
                    <stop offset="0" stopColor="#0EFAA5">
                        <animate id={"audioAnimation1"} dur="0ms" attributeName="offset" fill="freeze" from="0" to="1" />
                    </stop>
                    <stop offset="0" stopColor="#27BBB9">
                        <animate id={"audioAnimation2"} dur="0ms" attributeName="offset" fill="freeze" from="0" to="1" />
                    </stop>
                </linearGradient>
            <clipPath id="a">
                <path
